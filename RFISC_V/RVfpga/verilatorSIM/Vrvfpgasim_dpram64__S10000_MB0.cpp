...
VL_CTOR_IMP(Vrvfpgasim_dpram64__S10000_MB0) {
    // Reset internal values
    // Reset structure values
    _ctor_var_reset();
}

void Vrvfpgasim_dpram64__S10000_MB0::__Vconfigure(Vrvfpgasim__Syms* vlSymsp, bool first) {
    if (0 && first) {}  // Prevent unused
    this->__VlSymsp = vlSymsp;
}

Vrvfpgasim_dpram64__S10000_MB0::~Vrvfpgasim_dpram64__S10000_MB0() {
}

VL_INLINE_OPT void Vrvfpgasim_dpram64__S10000_MB0::_sequent__TOP__rvfpgasim__ram__ram__1(Vrvfpgasim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrvfpgasim_dpram64__S10000_MB0::_sequent__TOP__rvfpgasim__ram__ram__1\n"); );
...
void Vrvfpgasim_dpram64__S10000_MB0::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrvfpgasim_dpram64__S10000_MB0::_ctor_var_reset\n"); );
    // Body
