...
VL_CTOR_IMP(Vrvfpgasim_rvfpgasim) {
    ...
    VL_CELL(swervolf, Vrvfpgasim_swervolf_core__Bz1);
...
void Vrvfpgasim_rvfpgasim::_settle__TOP__rvfpgasim__2(Vrvfpgasim__Syms* __restrict vlSymsp) {
    ...
    vlSymsp->TOP__rvfpgasim__swervolf.io_data2__en 
        = vlSymsp->TOP__rvfpgasim.io_data2__en1;
    vlSymsp->TOP__rvfpgasim__swervolf.io_data__en = vlSymsp->TOP__rvfpgasim.io_data__en0;
                                           ...
                                           & (0xfe34U 
                                              | ((IData)(vlTOPp->i_sw0) 
                                                 | ((vlSymsp->TOP__rvfpgasim__swervolf.io_data__out 
                                                     & vlSymsp->TOP__rvfpgasim.io_data__en0) 
                                                    >> 0x10U))));
